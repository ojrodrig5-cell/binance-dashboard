...
def obtener_top_ganadoras():
    """Consulta la API pública de Binance Futures y devuelve (top N por % de
    cambio en 24h, dato de BTCUSDT). BTCUSDT se guarda siempre, esté o no en
...
def guardar_en_excel(top_ganadoras, btc_info=None):
    ...
    monedas_a_guardar = list(top_ganadoras)
